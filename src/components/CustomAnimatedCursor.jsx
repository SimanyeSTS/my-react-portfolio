...
const CustomAnimatedCursor = () => {
  ...
  // Convert HSL to RGB for cursor color
  useEffect(() => {
  ...
  // Track mouse position and detect cursor type
  useEffect(() => {
  ...
  const getLargeCursorStyles = () => {
    const baseStyles = {
      ...
      pointerEvents: 'none',
      zIndex: 9999, // Ensure it's above the loading screen but below the small cursor
      transform: 'translate(-50%, -50%)',
